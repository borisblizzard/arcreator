...
moveIngoreNames = ["setup.py", "setup.pyd", "src", "bin", "build", "dist", "log", "RTP", "plugins"] 
#  "Cache.py", "Controls.py" 
moveIncludeNames = ["__init__.py", "__main__.py", "_ext.py", "Logo.py", "ARCed.cfg", "Boot.py"]
moveIncludeNames.extend(testFiles)
copyPyds = ["_PyXAL.pyd"]  
...
move_compiled_dir("./", os.path.abspath(r"..\compiled"))
print ""
print "============================================="
