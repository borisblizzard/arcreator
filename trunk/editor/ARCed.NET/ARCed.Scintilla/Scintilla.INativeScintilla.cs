...
namespace ARCed.Scintilla
{
    public partial class Scintilla
    {
        ...
        internal void FireNeedShown(NativeScintillaEventArgs ea)
        {
            ...
            int firstLine	= this._ns.LineFromPosition(pos);
            int lastLine	= this._ns.LineFromPosition(pos + ea.SCNotification.length - 1);
            this.OnLinesNeedShown(new LinesNeedShownEventArgs(firstLine, lastLine));
        }
        ...
        internal void FireStyleNeeded(NativeScintillaEventArgs ea)
        {
            ...
            int startPos	= this._ns.GetEndStyled();
            int lineNumber	= this._ns.LineFromPosition(startPos);
            startPos		= this._ns.PositionFromLine(lineNumber);

            var snea = new StyleNeededEventArgs(new Range(startPos, ea.SCNotification.position, this));
            this.OnStyleNeeded(snea);
        }
        ...
        internal void FireUpdateUI(NativeScintillaEventArgs ea)
        {
            ...
            if (this.lastSelection.Start != this.Selection.Start
        ...
        {
            this._ns.SendMessageDirect(Constants.SCI_ADDREFDOCUMENT, IntPtr.Zero, pDoc);
        }
        ...
        {
            fixed (byte* bp = s)
                this._ns.SendMessageDirect(Constants.SCI_ADDSTYLEDTEXT, (IntPtr)length, (IntPtr)bp);
        }


        void INativeScintilla.AddText(int length, string s)
        {
            this._ns.SendMessageDirect(Constants.SCI_ADDTEXT, length, s);
        }


        void INativeScintilla.Allocate(int bytes)
        {
            this._ns.SendMessageDirect(Constants.SCI_ALLOCATE, bytes, 0);
        }


        void INativeScintilla.AppendText(int length, string s)
        {
            this._ns.SendMessageDirect(Constants.SCI_APPENDTEXT, length, s);
        }


        void INativeScintilla.AssignCmdKey(int keyDefinition, int sciCommand)
        {
            this._ns.SendMessageDirect(Constants.SCI_ASSIGNCMDKEY, keyDefinition, sciCommand);
        }


        bool INativeScintilla.AutoCActive()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCACTIVE, 0, 0) != 0;
        }


        void INativeScintilla.AutoCCancel()
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCCANCEL, 0, 0);
        }


        void INativeScintilla.AutoCComplete()
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCCOMPLETE, 0, 0);
        }


        bool INativeScintilla.AutoCGetAutoHide()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETAUTOHIDE, 0, 0) != 0;
        }


        bool INativeScintilla.AutoCGetCancelAtStart()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETCANCELATSTART, 0, 0) != 0;
        }


        bool INativeScintilla.AutoCGetChooseSingle()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETCHOOSESINGLE, 0, 0) != 0;
        }


        int INativeScintilla.AutoCGetCurrent()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETCURRENT, 0, 0);
        }


        bool INativeScintilla.AutoCGetDropRestOfWord()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETDROPRESTOFWORD, 0, 0) != 0;
        }


        bool INativeScintilla.AutoCGetIgnoreCase()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETIGNORECASE, 0, 0) != 0;
        }


        int INativeScintilla.AutoCGetMaxHeight()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETMAXHEIGHT, 0, 0);
        }


        int INativeScintilla.AutoCGetMaxWidth()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCGETMAXWIDTH, 0, 0);
        }


        char INativeScintilla.AutoCGetSeparator()
        {
            return (char)this._ns.SendMessageDirect(Constants.SCI_AUTOCGETSEPARATOR, 0, 0);
        }


        char INativeScintilla.AutoCGetTypeSeparator()
        {
            return (char)this._ns.SendMessageDirect(Constants.SCI_AUTOCGETTYPESEPARATOR, 0, 0);
        }


        int INativeScintilla.AutoCPosStart()
        {
            return this._ns.SendMessageDirect(Constants.SCI_AUTOCPOSSTART, 0, 0);
        }


        void INativeScintilla.AutoCSelect(string select)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSELECT, VOID.NULL, select);
        }


        void INativeScintilla.AutoCSetAutoHide(bool autoHide)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETAUTOHIDE, autoHide, 0);
        }


        void INativeScintilla.AutoCSetCancelAtStart(bool cancel)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETCANCELATSTART, cancel, 0);
        }


        void INativeScintilla.AutoCSetChooseSingle(bool chooseSingle)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETCHOOSESINGLE, chooseSingle, 0);
        }


        void INativeScintilla.AutoCSetDropRestOfWord(bool dropRestOfWord)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETDROPRESTOFWORD, dropRestOfWord, 0);
        }


        void INativeScintilla.AutoCSetFillUps(string chars)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETFILLUPS, VOID.NULL, chars);
        }


        void INativeScintilla.AutoCSetIgnoreCase(bool ignoreCase)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETIGNORECASE, ignoreCase, 0);
        }


        void INativeScintilla.AutoCSetMaxHeight(int rowCount)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETMAXHEIGHT, rowCount, 0);
        }


        void INativeScintilla.AutoCSetMaxWidth(int characterCount)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETMAXWIDTH, characterCount, 0);
        }


        void INativeScintilla.AutoCSetSeparator(char separator)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETSEPARATOR, separator, 0);
        }


        void INativeScintilla.AutoCSetTypeSeparator(char separatorCharacter)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSETTYPESEPARATOR, separatorCharacter, 0);
        }


        void INativeScintilla.AutoCShow(int lenEntered, string list)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSHOW, lenEntered, list);
        }


        void INativeScintilla.AutoCStops(string chars)
        {
            this._ns.SendMessageDirect(Constants.SCI_AUTOCSTOPS, VOID.NULL, chars);
        }


        void INativeScintilla.BackTab()
        {
            this._ns.SendMessageDirect(Constants.SCI_BACKTAB, 0, 0);
        }


        void INativeScintilla.BeginUndoAction()
        {
            this._ns.SendMessageDirect(Constants.SCI_BEGINUNDOACTION, 0, 0);
        }


        void INativeScintilla.BraceBadLight(int pos1)
        {
            this._ns.SendMessageDirect(Constants.SCI_BRACEBADLIGHT, pos1, 0);
        }


        void INativeScintilla.BraceHighlight(int pos1, int pos2)
        {
            this._ns.SendMessageDirect(Constants.SCI_BRACEHIGHLIGHT, pos1, pos2);
        }


        int INativeScintilla.BraceMatch(int pos, int maxReStyle)
        {
            return this._ns.SendMessageDirect(Constants.SCI_BRACEMATCH, pos, maxReStyle);
        }


        bool INativeScintilla.CallTipActive()
        {
            return this._ns.SendMessageDirect(Constants.SCI_CALLTIPACTIVE, 0, 0) != 0;
        }


        void INativeScintilla.CallTipCancel()
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPCANCEL, 0, 0);
        }


        int INativeScintilla.CallTipGetPosStart()
        {
            return this._ns.SendMessageDirect(Constants.SCI_CALLTIPPOSSTART, 0, 0);
        }


        void INativeScintilla.CallTipSetBack(int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPSETBACK, colour, 0);
        }


        void INativeScintilla.CallTipSetFore(int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPSETFORE, colour, 0);
        }


        void INativeScintilla.CallTipSetForeHlt(int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPSETFOREHLT, colour, 0);
        }


        void INativeScintilla.CallTipSetHlt(int hlStart, int hlEnd)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPSETHLT, hlStart, hlEnd);
        }


        void INativeScintilla.CallTipShow(int posStart, string definition)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPSHOW, posStart, definition);
        }


        void INativeScintilla.CallTipUseStyle(int tabsize)
        {
            this._ns.SendMessageDirect(Constants.SCI_CALLTIPUSESTYLE, tabsize, 0);
        }


        void INativeScintilla.Cancel()
        {
            this._ns.SendMessageDirect(Constants.SCI_CANCEL, 0, 0);
        }


        bool INativeScintilla.CanRedo()
        {
            return this._ns.SendMessageDirect(Constants.SCI_CANREDO, 0, 0) != 0;
        }


        bool INativeScintilla.CanUndo()
        {
            return this._ns.SendMessageDirect(Constants.SCI_CANUNDO, 0, 0) != 0;
        }


        void INativeScintilla.CharLeft()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARLEFT, 0, 0);
        }


        void INativeScintilla.CharLeftExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARLEFTEXTEND, 0, 0);
        }


        void INativeScintilla.CharLeftRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARLEFTRECTEXTEND, 0, 0);
        }


        void INativeScintilla.CharRight()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARRIGHT, 0, 0);
        }


        void INativeScintilla.CharRightExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARRIGHTEXTEND, 0, 0);
        }


        void INativeScintilla.CharRightRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHARRIGHTRECTEXTEND, 0, 0);
        }


        void INativeScintilla.ChooseCaretX()
        {
            this._ns.SendMessageDirect(Constants.SCI_CHOOSECARETX, 0, 0);
        }


        void INativeScintilla.Clear()
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEAR, 0, 0);
        }


        void INativeScintilla.ClearAll()
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEARALL, 0, 0);
        }


        void INativeScintilla.ClearAllCmdKeys()
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEARALLCMDKEYS, 0, 0);
        }


        void INativeScintilla.ClearCmdKey(int keyDefinition)
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEARCMDKEY, keyDefinition, 0);
        }


        void INativeScintilla.ClearDocumentStyle()
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEARDOCUMENTSTYLE, 0, 0);
        }


        void INativeScintilla.ClearRegisteredImages()
        {
            this._ns.SendMessageDirect(Constants.SCI_CLEARREGISTEREDIMAGES, 0, 0);
        }


        void INativeScintilla.Colourise(int start, int end)
        {
            this._ns.SendMessageDirect(Constants.SCI_COLOURISE, start, end);
        }


        void INativeScintilla.ConvertEols(int eolMode)
        {
            this._ns.SendMessageDirect(Constants.SCI_CONVERTEOLS, eolMode, 0);
        }


        IntPtr INativeScintilla.CreateDocument()
        {
            return (IntPtr)this._ns.SendMessageDirect(Constants.SCI_CREATEDOCUMENT, 0, 0);
        }


        void INativeScintilla.DeleteBack()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELETEBACK, 0, 0);
        }


        void INativeScintilla.DeleteBackNotLine()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELETEBACKNOTLINE, 0, 0);
        }


        void INativeScintilla.DelLineLeft()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELLINELEFT, 0, 0);
        }


        void INativeScintilla.DelLineRight()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELLINERIGHT, 0, 0);
        }


        void INativeScintilla.DelWordLeft()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELWORDLEFT, 0, 0);
        }


        void INativeScintilla.DelWordRight()
        {
            this._ns.SendMessageDirect(Constants.SCI_DELWORDRIGHT, 0, 0);
        }


        int INativeScintilla.DocLineFromVisible(int displayLine)
        {
            return this._ns.SendMessageDirect(Constants.SCI_DOCLINEFROMVISIBLE, displayLine, 0);
        }


        void INativeScintilla.DocumentEnd()
        {
            this._ns.SendMessageDirect(Constants.SCI_DOCUMENTEND, 0, 0);
        }


        void INativeScintilla.DocumentEndExtend()
        {
            this._ns.SendMessageDirect(2319, 0, 0);
        }


        void INativeScintilla.DocumentStart()
        {
            this._ns.SendMessageDirect(Constants.SCI_DOCUMENTSTART, 0, 0);
        }


        void INativeScintilla.DocumentStartExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_DOCUMENTSTARTEXTEND, 0, 0);
        }


        void INativeScintilla.EditToggleOvertype()
        {
            this._ns.SendMessageDirect(Constants.SCI_EDITTOGGLEOVERTYPE, 0, 0);
        }


        void INativeScintilla.EmptyUndoBuffer()
        {
            this._ns.SendMessageDirect(Constants.SCI_EMPTYUNDOBUFFER, 0, 0);
        }
        ...
        {
            this._ns.SendMessageDirect(Constants.SCI_ENDUNDOACTION, 0, 0);
        }


        void INativeScintilla.EnsureVisible(int line)
        {
            this._ns.SendMessageDirect(Constants.SCI_ENSUREVISIBLE, line, 0);
        }


        void INativeScintilla.EnsureVisibleEnforcePolicy(int line)
        {
            this._ns.SendMessageDirect(Constants.SCI_ENSUREVISIBLEENFORCEPOLICY, line, 0);
        }


        int INativeScintilla.FindColumn(int line, int column)
        {
            return this._ns.SendMessageDirect(Constants.SCI_FINDCOLUMN, line, column);
        }
        ...
        unsafe int INativeScintilla.FindText(int searchFlags, ref TextToFind ttf)
        {
            ...
            fixed (TextToFind* ttfp = &ttf)
                return (int)this._ns.SendMessageDirect(Constants.SCI_FINDTEXT, (IntPtr)searchFlags, (IntPtr)ttfp);
        }
        ...
        unsafe int INativeScintilla.FormatRange(bool bDraw, ref RangeToFormat pfr)
        {
            fixed (RangeToFormat* rtfp = &pfr)
                return (int)this._ns.SendMessageDirect(Constants.SCI_FORMATRANGE, (IntPtr)(bDraw ? 1 : 0), (IntPtr)rtfp);
        }


        void INativeScintilla.FormFeed()
        {
            this._ns.SendMessageDirect(Constants.SCI_FORMFEED, 0, 0);
        }


        int INativeScintilla.GetAnchor()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETANCHOR, 0, 0);
        }


        bool INativeScintilla.GetBackSpaceUnIndents()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETBACKSPACEUNINDENTS, 0, 0) != 0;
        }


        bool INativeScintilla.GetBufferedDraw()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETBUFFEREDDRAW, 0, 0) != 0;
        }


        int INativeScintilla.GetCaretFore()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETFORE, 0, 0);
        }


        int INativeScintilla.GetCaretLineBack()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETLINEBACK, 0, 0);
        }


        int INativeScintilla.GetCaretLineBackAlpha()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETLINEBACKALPHA, 0, 0);
        }


        bool INativeScintilla.GetCaretLineVisible()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETLINEVISIBLE, 0, 0) != 0;
        }


        int INativeScintilla.GetCaretPeriod()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETPERIOD, 0, 0);
        }


        bool INativeScintilla.GetCaretSticky()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETSTICKY, 0, 0) != 0;
        }


        int INativeScintilla.GetCaretStyle()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETSTYLE, 0, 0);
        }


        int INativeScintilla.GetCaretWidth()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCARETWIDTH, 0, 0);
        }


        char INativeScintilla.GetCharAt(int position)
        {
            return (char)this._ns.SendMessageDirect(Constants.SCI_GETCHARAT, position, 0);
        }


        int INativeScintilla.GetCodePage()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCODEPAGE, 0, 0);
        }


        int INativeScintilla.GetColumn(int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCOLUMN, position, 0);
        }


        int INativeScintilla.GetControlCharSymbol()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCONTROLCHARSYMBOL, 0, 0);
        }


        int INativeScintilla.GetCurrentPos()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCURRENTPOS, 0, 0);
        }


        int INativeScintilla.GetCursor()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETCURSOR, 0, 0);
        }


        IntPtr INativeScintilla.GetDocPointer()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETDOCPOINTER, IntPtr.Zero, IntPtr.Zero);
        }


        int INativeScintilla.GetEdgeColour()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETEDGECOLOUR, 0, 0);
        }


        int INativeScintilla.GetEdgeColumn()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETEDGECOLUMN, 0, 0);
        }


        int INativeScintilla.GetEdgeMode()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETEDGEMODE, 0, 0);
        }


        bool INativeScintilla.GetEndAtLastLine()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETENDATLASTLINE, 0, 0) != 0;
        }


        int INativeScintilla.GetEndStyled()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETENDSTYLED, 0, 0);
        }


        int INativeScintilla.GetEolMode()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETEOLMODE, 0, 0);
        }


        int INativeScintilla.GetFirstVisibleLine()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETFIRSTVISIBLELINE, 0, 0);
        }


        bool INativeScintilla.GetFocus()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETFOCUS, 0, 0) != 0;
        }


        bool INativeScintilla.GetFoldExpanded(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETFOLDEXPANDED, line, 0) != 0;
        }


        uint INativeScintilla.GetFoldLevel(int line)
        {
            return (uint)this._ns.SendMessageDirect(Constants.SCI_GETFOLDLEVEL, line, 0);
        }


        int INativeScintilla.GetFoldParent(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETFOLDPARENT, line, 0);
        }


        int INativeScintilla.GetHighlightGuide()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHIGHLIGHTGUIDE, 0, 0);
        }


        int INativeScintilla.GetHotspotActiveBack()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHOTSPOTACTIVEBACK, 0, 0);
        }


        int INativeScintilla.GetHotspotActiveFore()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHOTSPOTACTIVEFORE, 0, 0);
        }


        bool INativeScintilla.GetHotspotActiveUnderline()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHOTSPOTACTIVEUNDERLINE, 0, 0) != 0;
        }


        bool INativeScintilla.GetHotspotSingleLine()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHOTSPOTSINGLELINE, 0, 0) != 0;
        }


        bool INativeScintilla.GetHScrollBar()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETHSCROLLBAR, 0, 0) != 0;
        }


        int INativeScintilla.GetIndent()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETINDENT, 0, 0);
        }


        bool INativeScintilla.GetIndentationGuides()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETINDENTATIONGUIDES, 0, 0) != 0;
        }


        int INativeScintilla.GetIndicatorCurrent()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETINDICATORCURRENT, 0, 0);
        }


        int INativeScintilla.GetIndicatorValue()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETINDICATORVALUE, 0, 0);
        }


        int INativeScintilla.GetLastChild(int line, int level)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLASTCHILD, line, level);
        }


        int INativeScintilla.GetLength()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLENGTH, 0, 0);
        }


        int INativeScintilla.GetLexer()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLEXER, 0, 0);
        }


        int INativeScintilla.GetLine(int line, out string text)
        {
            int length = this._ns.SendMessageDirect(Constants.SCI_GETLINE, line, 0);
            if (length == 0)
            {
                text = string.Empty;
                return 0;
            ...
            return this._ns.SendMessageDirect(Constants.SCI_GETLINE, (IntPtr)line, out text, length);
        }


        int INativeScintilla.GetLineEndPosition(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINEENDPOSITION, line, 0);
        }


        int INativeScintilla.GetLineIndentation(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINEINDENTATION, line, 0);
        }


        int INativeScintilla.GetLineIndentPosition(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINEINDENTPOSITION, line, 0);
        }


        int INativeScintilla.GetLineSelEndPosition(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINESELENDPOSITION, line, 0);
        }


        int INativeScintilla.GetLineSelStartPosition(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINESELSTARTPOSITION, line, 0);
        }


        int INativeScintilla.GetLineState(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINESTATE, line, 0);
        }


        bool INativeScintilla.GetLineVisible(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETLINEVISIBLE, line, 0) != 0;
        }


        int INativeScintilla.GetMarginLeft()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINLEFT, 0, 0);
        }


        int INativeScintilla.GetMarginMaskN(int margin)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINMASKN, margin, 0);
        }


        int INativeScintilla.GetMarginRight()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINRIGHT, 0, 0);
        }


        bool INativeScintilla.GetMarginSensitiveN(int margin)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINSENSITIVEN, margin, 0) != 0;
        }


        int INativeScintilla.GetMarginTypeN(int margin)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINTYPEN, margin, 0);
        }


        int INativeScintilla.GetMarginWidthN(int margin)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMARGINWIDTHN, margin, 0);
        }


        int INativeScintilla.GetMaxLineState()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMAXLINESTATE, 0, 0);
        }


        int INativeScintilla.GetModEventMask()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMODEVENTMASK, 0, 0);
        }


        bool INativeScintilla.GetModify()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMODIFY, 0, 0) != 0;
        }


        bool INativeScintilla.GetMouseDownCaptures()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMOUSEDOWNCAPTURES, 0, 0) != 0;
        }


        int INativeScintilla.GetMouseDwellTime()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETMOUSEDWELLTIME, 0, 0);
        }


        bool INativeScintilla.GetOvertype()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETOVERTYPE, 0, 0) != 0;
        }


        int INativeScintilla.GetPrintColourMode()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETPRINTCOLOURMODE, 0, 0);
        }


        int INativeScintilla.GetPrintMagnification()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETPRINTMAGNIFICATION, 0, 0);
        }


        int INativeScintilla.GetPrintWrapMode()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETPRINTWRAPMODE, 0, 0);
        }


        void INativeScintilla.GetProperty(string key, out string value)
        {
            this._ns.SendMessageDirect(Constants.SCI_GETPROPERTY, key, out value);
        }


        void INativeScintilla.GetPropertyExpanded(string key, out string value)
        {
            this._ns.SendMessageDirect(Constants.SCI_GETPROPERTYEXPANDED, key, out value);
        }


        int INativeScintilla.GetPropertyInt(string key, int @default)
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETPROPERTYINT, key, @default);
        }


        bool INativeScintilla.GetReadOnly()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETREADONLY, 0, 0) != 0;
        }


        int INativeScintilla.GetScrollWidth()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSCROLLWIDTH, 0, 0);
        }


        int INativeScintilla.GetSearchFlags()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSEARCHFLAGS, 0, 0);
        }


        int INativeScintilla.GetSelectionEnd()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSELECTIONEND, 0, 0);
        }


        int INativeScintilla.GetSelectionMode()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSELECTIONMODE, 0, 0);
        }


        int INativeScintilla.GetSelectionStart()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSELECTIONSTART, 0, 0);
        }
        ...
        void INativeScintilla.GetSelText(out string text)
        {
            ...
            this._ns.SendMessageDirect(Constants.SCI_GETSELTEXT, IntPtr.Zero, out text, length);
        }


        int INativeScintilla.GetStatus()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSTATUS, 0, 0);
        }


        byte INativeScintilla.GetStyleAt(int position)
        {
            return (byte)this._ns.SendMessageDirect(Constants.SCI_GETSTYLEAT, position, 0);
        }


        int INativeScintilla.GetStyleBits()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSTYLEBITS, 0, 0);
        }


        int INativeScintilla.GetStyleBitsNeeded()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETSTYLEBITSNEEDED, 0, 0);
        }
        ...
        unsafe void INativeScintilla.GetStyledText(ref TextRange tr)
        {
            fixed (TextRange* trp = &tr)
                this._ns.SendMessageDirect(Constants.SCI_GETSTYLEDTEXT, IntPtr.Zero, (IntPtr)trp);
        }


        bool INativeScintilla.GetTabIndents()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTABINDENTS, 0, 0) != 0;
        }


        int INativeScintilla.GetTabWidth()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTABWIDTH, 0, 0);
        }


        int INativeScintilla.GetTargetEnd()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTARGETEND, 0, 0);
        }


        int INativeScintilla.GetTargetStart()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTARGETSTART, 0, 0);
        }
        ...
        {
            fixed (TextRange* trp = &tr)
                return (int)this._ns.SendMessageDirect(Constants.SCI_GETTEXTRANGE, IntPtr.Zero, (IntPtr)trp);
        }


        int INativeScintilla.GetTextLength()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTEXTLENGTH, 0, 0);
        }


        bool INativeScintilla.GetTwoPhaseDraw()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETTWOPHASEDRAW, 0, 0) != 0;
        }


        bool INativeScintilla.GetUndoCollection()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETUNDOCOLLECTION, 0, 0) != 0;
        }


        bool INativeScintilla.GetUsePalette()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETUSEPALETTE, 0, 0) != 0;
        }


        bool INativeScintilla.GetUseTabs()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETUSETABS, 0, 0) != 0;
        }


        bool INativeScintilla.GetViewEol()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETVIEWEOL, 0, 0) != 0;
        }


        int INativeScintilla.GetViewWs()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETVIEWWS, 0, 0);
        }


        bool INativeScintilla.GetVScrollBar()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETVSCROLLBAR, 0, 0) != 0;
        }


        int INativeScintilla.GetXOffset()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETXOFFSET, 0, 0);
        }


        int INativeScintilla.GetZoom()
        {
            return this._ns.SendMessageDirect(Constants.SCI_GETZOOM, 0, 0);
        }


        void INativeScintilla.GotoLine(int line)
        {
            this._ns.SendMessageDirect(Constants.SCI_GOTOLINE, line, 0);
        }


        void INativeScintilla.GotoPos(int position)
        {
            this._ns.SendMessageDirect(Constants.SCI_GOTOPOS, position, 0);
        }


        void INativeScintilla.GrabFocus()
        {
            this._ns.SendMessageDirect(Constants.SCI_GRABFOCUS, 0, 0);
        }


        void INativeScintilla.HideLines(int lineStart, int lineEnd)
        {
            this._ns.SendMessageDirect(Constants.SCI_HIDELINES, lineStart, lineEnd);
        }


        void INativeScintilla.HideSelection(bool hide)
        {
            this._ns.SendMessageDirect(Constants.SCI_HIDESELECTION, hide, 0);
        }


        void INativeScintilla.Home()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOME, 0, 0);
        }


        void INativeScintilla.HomeDisplay()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMEDISPLAY, 0, 0);
        }


        void INativeScintilla.HomeDisplayExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMEDISPLAYEXTEND, 0, 0);
        }


        void INativeScintilla.HomeExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMEEXTEND, 0, 0);
        }


        void INativeScintilla.HomeRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMERECTEXTEND, 0, 0);
        }


        void INativeScintilla.HomeWrap()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMEWRAP, 0, 0);
        }


        void INativeScintilla.HomeWrapExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_HOMEWRAPEXTEND, 0, 0);
        }


        uint INativeScintilla.IndicatorAllOnFor(int position)
        {
            return (uint)this._ns.SendMessageDirect(Constants.SCI_INDICATORALLONFOR, position, 0);
        }


        void INativeScintilla.IndicatorClearRange(int position, int fillLength)
        {
            this._ns.SendMessageDirect(Constants.SCI_INDICATORCLEARRANGE, position, fillLength);
        }


        int INativeScintilla.IndicatorEnd(int indicator, int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICATOREND, indicator, position);
        }


        void INativeScintilla.IndicatorFillRange(int position, int fillLength)
        {
            this._ns.SendMessageDirect(Constants.SCI_INDICATORFILLRANGE, position, fillLength);
        }


        int INativeScintilla.IndicatorStart(int indicator, int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICATORSTART, indicator, position);
        }


        int INativeScintilla.IndicatorValueAt(int indicator, int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICATORVALUEAT, indicator, position);
        }


        int INativeScintilla.IndicGetFore(int indicatorNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICGETFORE, indicatorNumber, 0);
        }


        int INativeScintilla.IndicGetStyle(int indicatorNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICGETSTYLE, indicatorNumber, 0);
        }


        bool INativeScintilla.IndicGetUnder(int indicatorNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_INDICGETUNDER, indicatorNumber, 0) != 0;
        }


        void INativeScintilla.IndicSetFore(int indicatorNumber, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_INDICSETFORE, indicatorNumber, colour);
        }


        void INativeScintilla.IndicSetStyle(int indicatorNumber, int indicatorStyle)
        {
            this._ns.SendMessageDirect(Constants.SCI_INDICSETSTYLE, indicatorNumber, indicatorStyle);
        }


        void INativeScintilla.IndicSetUnder(int indicatorNumber, bool under)
        {
            this._ns.SendMessageDirect(Constants.SCI_INDICSETUNDER, indicatorNumber, under);
        }


        void INativeScintilla.InsertText(int pos, string text)
        {
            this._ns.SendMessageDirect(Constants.SCI_INSERTTEXT, pos, text);
        }


        void INativeScintilla.LineCopy()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINECOPY, 0, 0);
        }


        void INativeScintilla.LineCut()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINECUT, 0, 0);
        }


        void INativeScintilla.LineDelete()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEDELETE, 0, 0);
        }


        void INativeScintilla.LineDown()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEDOWN, 0, 0);
        }


        void INativeScintilla.LineDownExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEDOWNEXTEND, 0, 0);
        }


        void INativeScintilla.LineDownRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEDOWNRECTEXTEND, 0, 0);
        }


        void INativeScintilla.LineDuplicate()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEDUPLICATE, 0, 0);
        }


        void INativeScintilla.LineEnd()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEEND, 0, 0);
        }


        void INativeScintilla.LineEndDisplay()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDDISPLAY, 0, 0);
        }


        void INativeScintilla.LineEndDisplayExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDDISPLAYEXTEND, 0, 0);
        }


        void INativeScintilla.LineEndExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDEXTEND, 0, 0);
        }


        void INativeScintilla.LineEndRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDRECTEXTEND, 0, 0);
        }


        void INativeScintilla.LineEndWrap()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDWRAP, 0, 0);
        }


        void INativeScintilla.LineEndWrapExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEENDWRAPEXTEND, 0, 0);
        }


        int INativeScintilla.LineFromPosition(int pos)
        {
            return this._ns.SendMessageDirect(Constants.SCI_LINEFROMPOSITION, pos, 0);
        }


        int INativeScintilla.LineLength(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_LINELENGTH, line, 0);
        }


        void INativeScintilla.LineScroll(int columns, int lines)
        {
            this._ns.SendMessageDirect(Constants.SCI_LINESCROLL, columns, lines);
        }


        void INativeScintilla.LineScrollDown()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINESCROLLDOWN, 0, 0);
        }


        void INativeScintilla.LineScrollUp()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINESCROLLUP, 0, 0);
        }


        int INativeScintilla.LinesOnScreen()
        {
            return this._ns.SendMessageDirect(Constants.SCI_LINESONSCREEN, 0, 0);
        }


        void INativeScintilla.LineTranspose()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINETRANSPOSE, 0, 0);
        }


        void INativeScintilla.LineUp()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEUP, 0, 0);
        }


        void INativeScintilla.LineUpExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEUPEXTEND, 0, 0);
        }


        void INativeScintilla.LineUpRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_LINEUPRECTEXTEND, 0, 0);
        }


        void INativeScintilla.LoadLexerLibrary(string path)
        {
            this._ns.SendMessageDirect(Constants.SCI_LOADLEXERLIBRARY, VOID.NULL, path);
        }


        void INativeScintilla.LowerCase()
        {
            this._ns.SendMessageDirect(Constants.SCI_LOWERCASE, 0, 0);
        }


        int INativeScintilla.MarkerAdd(int line, int markerNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_MARKERADD, line, markerNumber);
        }


        void INativeScintilla.MarkerAddSet(int line, uint markerMask)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERADDSET, line, markerMask);
        }


        void INativeScintilla.MarkerDefine(int markerNumber, int markerSymbol)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERDEFINE, markerNumber, markerSymbol);
        }


        void INativeScintilla.MarkerDefinePixmap(int markerNumber, string xpm)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERDEFINEPIXMAP, markerNumber, xpm);
        }


        void INativeScintilla.MarkerDelete(int line, int markerNumber)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERDELETE, line, markerNumber);
        }


        void INativeScintilla.MarkerDeleteAll(int markerNumber)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERDELETEALL, markerNumber, 0);
        }


        void INativeScintilla.MarkerDeleteHandle(int handle)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERDELETEHANDLE, handle, 0);
        }


        int INativeScintilla.MarkerGet(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_MARKERGET, line, 0);
        }


        int INativeScintilla.MarkerLineFromHandle(int handle)
        {
            return this._ns.SendMessageDirect(Constants.SCI_MARKERLINEFROMHANDLE, handle, 0);
        }


        int INativeScintilla.MarkerNext(int lineStart, uint markerMask)
        {
            return this._ns.SendMessageDirect(Constants.SCI_MARKERNEXT, lineStart, markerMask);
        }


        int INativeScintilla.MarkerPrevious(int lineStart, uint markerMask)
        {
            return this._ns.SendMessageDirect(Constants.SCI_MARKERPREVIOUS, lineStart, markerMask);
        }


        void INativeScintilla.MarkerSetAlpha(int markerNumber, int alpha)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERSETALPHA, markerNumber, alpha);
        }


        void INativeScintilla.MarkerSetBack(int markerNumber, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERSETBACK, markerNumber, colour);
        }


        void INativeScintilla.MarkerSetFore(int markerNumber, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_MARKERSETFORE, markerNumber, colour);
        }


        void INativeScintilla.MoveCaretInsideView()
        {
            this._ns.SendMessageDirect(Constants.SCI_MOVECARETINSIDEVIEW, 0, 0);
        }


        void INativeScintilla.NewLine()
        {
            this._ns.SendMessageDirect(Constants.SCI_NEWLINE, 0, 0);
        }


        void INativeScintilla.Null()
        {
            this._ns.SendMessageDirect(Constants.SCI_NULL, 0, 0);
        }


        void INativeScintilla.PageDown()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEDOWN, 0, 0);
        }


        void INativeScintilla.PageDownExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEDOWNEXTEND, 0, 0);
        }


        void INativeScintilla.PageDownRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEDOWNRECTEXTEND, 0, 0);
        }


        void INativeScintilla.PageUp()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEUP, 0, 0);
        }


        void INativeScintilla.PageUpExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEUPEXTEND, 0, 0);
        }


        void INativeScintilla.PageUpRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PAGEUPRECTEXTEND, 0, 0);
        }


        void INativeScintilla.ParaDown()
        {
            this._ns.SendMessageDirect(Constants.SCI_PARADOWN, 0, 0);
        }


        void INativeScintilla.ParaDownExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PARADOWNEXTEND, 0, 0);
        }


        void INativeScintilla.ParaUp()
        {
            this._ns.SendMessageDirect(Constants.SCI_PARAUP, 0, 0);
        }


        void INativeScintilla.ParaUpExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_PARAUPEXTEND, 0, 0);
        }


        int INativeScintilla.PointXFromPosition(int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POINTXFROMPOSITION, VOID.NULL, position);
        }


        int INativeScintilla.PointYFromPosition(int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POINTYFROMPOSITION, VOID.NULL, position);
        }


        int INativeScintilla.PositionAfter(int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POSITIONAFTER, position, 0);
        }


        int INativeScintilla.PositionBefore(int position)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POSITIONBEFORE, position, 0);
        }


        int INativeScintilla.PositionFromLine(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POSITIONFROMLINE, line, 0);
        }


        int INativeScintilla.PositionFromPoint(int x, int y)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POSITIONFROMPOINT, x, y);
        }


        int INativeScintilla.PositionFromPointClose(int x, int y)
        {
            return this._ns.SendMessageDirect(Constants.SCI_POSITIONFROMPOINTCLOSE, x, y);
        }


        void INativeScintilla.Redo()
        {
            this._ns.SendMessageDirect(Constants.SCI_REDO, 0, 0);
        }


        void INativeScintilla.RegisterImage(int type, string xpmData)
        {
            this._ns.SendMessageDirect(Constants.SCI_REGISTERIMAGE, type, xpmData);
        }


        void INativeScintilla.ReleaseDocument(IntPtr pDoc)
        {
            this._ns.SendMessageDirect(Constants.SCI_RELEASEDOCUMENT, IntPtr.Zero, pDoc);
        }


        void INativeScintilla.ReplaceSel(string text)
        {
            this._ns.SendMessageDirect(Constants.SCI_REPLACESEL, VOID.NULL, text);
        }


        int INativeScintilla.ReplaceTarget(int length, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_REPLACETARGET, length, text);
        }


        int INativeScintilla.ReplaceTargetRE(int length, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_REPLACETARGETRE, length, text);
        }


        void INativeScintilla.ScrollCaret()
        {
            this._ns.SendMessageDirect(Constants.SCI_SCROLLCARET, 0, 0);
        }


        void INativeScintilla.SearchAnchor()
        {
            this._ns.SendMessageDirect(Constants.SCI_SEARCHANCHOR, 0, 0);
        }


        int INativeScintilla.SearchInTarget(int length, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_SEARCHINTARGET, length, text);
        }


        int INativeScintilla.SearchNext(int searchFlags, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_SEARCHNEXT, searchFlags, text);
        }


        int INativeScintilla.SearchPrev(int searchFlags, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_SEARCHPREV, searchFlags, text);
        }


        void INativeScintilla.SelectAll()
        {
            this._ns.SendMessageDirect(Constants.SCI_SELECTALL, 0, 0);
        }


        void INativeScintilla.SelectionDuplicate()
        {
            this._ns.SendMessageDirect(Constants.SCI_SELECTIONDUPLICATE, 0, 0);
        }


        bool INativeScintilla.SelectionIsRectangle()
        {
            return this._ns.SendMessageDirect(Constants.SCI_SELECTIONISRECTANGLE, 0, 0) != 0;
        }
        ...
        int INativeScintilla.SendMessageDirect(uint msg, int wParam, uint lParam)
        {
            ...
            {
                var i = (int)lParam;
                return (int)this._ns.SendMessageDirect(msg, (IntPtr)wParam, (IntPtr)i);
            }
        ...
        unsafe int INativeScintilla.SendMessageDirect(uint msg, IntPtr wParam, out string text, int length)
        {
            ...
            {
                ret = this._ns.SendMessageDirect(msg, wParam, (IntPtr)bp);
            ...
            text = this._encoding.GetString(buffer, 0, length);
        ...
        unsafe int INativeScintilla.SendMessageDirect(uint msg, int wParam, string lParam)
        {
            ...
            fixed (byte* bp = this._encoding.GetBytes(ZeroTerminated(lParam)))
                return (int)this._ns.SendMessageDirect(msg, (IntPtr)wParam, (IntPtr)bp);
        }
        ...
        unsafe int INativeScintilla.SendMessageDirect(uint msg, VOID NULL, string lParam)
        {
            ...
            //  UTF-16 strings into a document encoded byte array.
            fixed (byte* bp = this._encoding.GetBytes(ZeroTerminated(lParam)))
                return (int)this._ns.SendMessageDirect(msg, IntPtr.Zero, (IntPtr)bp);
        }
        ...
        {
            fixed (byte* bpw = this._encoding.GetBytes(ZeroTerminated(wParam)))
            fixed (byte* bpl = this._encoding.GetBytes(ZeroTerminated(lParam)))
                return (int)this._ns.SendMessageDirect(msg, (IntPtr)bpw, (IntPtr)bpl);
        }
        ...
        unsafe int INativeScintilla.SendMessageDirect(uint msg, string wParam, out string stringResult)
        {
            ...
            fixed (byte* bpw = this._encoding.GetBytes(ZeroTerminated(wParam)))
            {
                var length = (int)this._ns.SendMessageDirect(msg, (IntPtr)bpw, IntPtr.Zero);


                var buffer = new byte[length + 1];

                fixed (byte* bpl = buffer)
                    ret = this._ns.SendMessageDirect(msg, (IntPtr)bpw, (IntPtr)bpl);

                stringResult = this._encoding.GetString(buffer, 0, length);
            }
        ...
        {
            fixed (byte* bp = this._encoding.GetBytes(ZeroTerminated(wParam)))
                return (int)this._ns.SendMessageDirect(msg, (IntPtr)bp, (IntPtr)lParam);
        }
        ...
        {
            fixed (byte* bp = this._encoding.GetBytes(ZeroTerminated(wParam)))
                return (int)this._ns.SendMessageDirect(msg, (IntPtr)bp, IntPtr.Zero);
        }


        void INativeScintilla.SetAnchor(int position)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETANCHOR, position, 0);
        }


        void INativeScintilla.SetBackSpaceUnIndents(bool bsUnIndents)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETBACKSPACEUNINDENTS, bsUnIndents, 0);
        }


        void INativeScintilla.SetBufferedDraw(bool isBuffered)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETBUFFEREDDRAW, isBuffered, 0);
        }


        void INativeScintilla.SetCaretFore(int alpha)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETFORE, alpha, 0);
        }


        void INativeScintilla.SetCaretLineBack(int show)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETLINEBACK, show, 0);
        }


        void INativeScintilla.SetCaretLineBackAlpha(int alpha)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETLINEBACKALPHA, alpha, 0);
        }


        void INativeScintilla.SetCaretLineVisible(bool colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETLINEVISIBLE, colour, 0);
        }


        void INativeScintilla.SetCaretPeriod(int milliseconds)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETPERIOD, milliseconds, 0);
        }


        void INativeScintilla.SetCaretSticky(bool useCaretStickyBehaviour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETSTICKY, useCaretStickyBehaviour, 0);
        }


        void INativeScintilla.SetCaretStyle(int style)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETSTYLE, style, 0);
        }


        void INativeScintilla.SetCaretWidth(int pixels)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCARETWIDTH, pixels, 0);
        }


        void INativeScintilla.SetCharsDefault()
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCHARSDEFAULT, 0, 0);
        }


        void INativeScintilla.SetCodePage(int codePage)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCODEPAGE, codePage, 0);
        ...
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCONTROLCHARSYMBOL, symbol, 0);
        }


        void INativeScintilla.SetCurrentPos(int position)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCURRENTPOS, position, 0);
        }


        void INativeScintilla.SetCursor(int curType)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETCURSOR, curType, 0);
        }


        void INativeScintilla.SetDocPointer(IntPtr pDoc)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETDOCPOINTER, IntPtr.Zero, pDoc);
        }


        void INativeScintilla.SetEdgeColour(int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETEDGECOLOUR, colour, 0);
        }


        void INativeScintilla.SetEdgeColumn(int column)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETEDGECOLUMN, column, 0);
        }


        void INativeScintilla.SetEdgeMode(int mode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETEDGEMODE, mode, 0);
        }


        void INativeScintilla.SetEndAtLastLine(bool endAtLastLine)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETENDATLASTLINE, endAtLastLine, 0);
        }


        void INativeScintilla.SetEolMode(int eolMode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETEOLMODE, eolMode, 0);
        }


        void INativeScintilla.SetFocus(bool focus)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOCUS, focus, 0);
        }


        void INativeScintilla.SetFoldExpanded(int line, bool expanded)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOLDEXPANDED, line, expanded);
        }


        void INativeScintilla.SetFoldFlags(int flags)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOLDFLAGS, flags, 0);
        }


        void INativeScintilla.SetFoldLevel(int line, uint level)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOLDLEVEL, line, level);
        }


        void INativeScintilla.SetFoldMarginColour(bool useSetting, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOLDMARGINCOLOUR, useSetting, colour);
        }


        void INativeScintilla.SetFoldMarginHiColour(bool useSetting, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETFOLDMARGINHICOLOUR, useSetting, colour);
        }


        void INativeScintilla.SetHighlightGuide(int column)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHIGHLIGHTGUIDE, column, 0);
        }


        void INativeScintilla.SetHotspotActiveBack(bool useHotspotBackColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHOTSPOTACTIVEBACK, useHotspotBackColour, colour);
        }


        void INativeScintilla.SetHotspotActiveFore(bool useHotspotForeColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHOTSPOTACTIVEFORE, useHotspotForeColour, colour);
        }


        void INativeScintilla.SetHotspotActiveUnderline(bool underline)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHOTSPOTACTIVEUNDERLINE, underline, 0);
        }


        void INativeScintilla.SetHotspotSingleLine(bool singleLine)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHOTSPOTSINGLELINE, singleLine, 0);
        }


        void INativeScintilla.SetHScrollBar(bool visible)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETHSCROLLBAR, visible, 0);
        }


        void INativeScintilla.SetIndent(int widthInChars)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETINDENT, widthInChars, 0);
        }


        void INativeScintilla.SetIndentationGuides(bool view)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETINDENTATIONGUIDES, view, 0);
        }


        void INativeScintilla.SetIndicatorCurrent(int indicator)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETINDICATORCURRENT, indicator, 0);
        }


        void INativeScintilla.SetIndicatorValue(int value)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETINDICATORVALUE, value, 0);
        }


        void INativeScintilla.SetKeywords(int keywordSet, string keyWordList)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETKEYWORDS, keywordSet, keyWordList);
        }
        ...
        {
            this._ns.SendMessageDirect(Constants.SCI_SETLEXER, lexer, 0);
        }


        void INativeScintilla.SetLexerLanguage(string name)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETLEXERLANGUAGE, VOID.NULL, name);
        }


        void INativeScintilla.SetLineIndentation(int line, int indentation)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETLINEINDENTATION, line, indentation);
        }


        void INativeScintilla.SetLineState(int line, int value)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETLINESTATE, line, value);
        }


        void INativeScintilla.SetMarginLeft(int pixels)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINLEFT, 0, pixels);
        }


        void INativeScintilla.SetMarginMaskN(int margin, int mask)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINMASKN, margin, mask);
        }


        void INativeScintilla.SetMarginRight(int pixels)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINRIGHT, 0, pixels);
        }


        void INativeScintilla.SetMarginSensitiveN(int margin, bool sensitive)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINSENSITIVEN, margin, sensitive);
        }


        void INativeScintilla.SetMarginTypeN(int margin, int type)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINTYPEN, margin, type);
        }


        void INativeScintilla.SetMarginWidthN(int margin, int pixelWidth)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMARGINWIDTHN, margin, pixelWidth);
        }


        void INativeScintilla.SetModEventMask(int modEventMask)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMODEVENTMASK, modEventMask, 0);
        }


        void INativeScintilla.SetMouseDownCaptures(bool captures)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMOUSEDOWNCAPTURES, captures, 0);
        }


        void INativeScintilla.SetMouseDwellTime(int mouseDwellTime)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETMOUSEDWELLTIME, mouseDwellTime, 0);
        }


        void INativeScintilla.SetOvertype(bool overType)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETOVERTYPE, overType, 0);
        }


        void INativeScintilla.SetPrintColourMode(int mode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETPRINTCOLOURMODE, mode, 0);
        }


        void INativeScintilla.SetPrintMagnification(int magnification)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETPRINTMAGNIFICATION, magnification, 0);
        }


        void INativeScintilla.SetPrintWrapMode(int wrapMode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETPRINTWRAPMODE, wrapMode, 0);
        }


        void INativeScintilla.SetProperty(string key, string value)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETPROPERTY, key, value);
        }


        void INativeScintilla.SetReadOnly(bool readOnly)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETREADONLY, readOnly, 0);
        }


        void INativeScintilla.SetSavePoint()
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSAVEPOINT, 0, 0);
        }


        void INativeScintilla.SetScrollWidth(int pixelWidth)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSCROLLWIDTH, pixelWidth, 0);
        }


        void INativeScintilla.SetSearchFlags(int searchFlags)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSEARCHFLAGS, searchFlags, 0);
        }


        void INativeScintilla.SetSel(int anchorPos, int currentPos)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSEL, anchorPos, currentPos);
        }


        void INativeScintilla.SetSelBack(bool useSelectionBackColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSELBACK, useSelectionBackColour, colour);
        }


        void INativeScintilla.SetSelectionEnd(int position)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSELECTIONEND, position, 0);
        }


        void INativeScintilla.SetSelectionMode(int mode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSELECTIONMODE, mode, 0);
        }


        void INativeScintilla.SetSelectionStart(int position)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSELECTIONSTART, position, 0);
        }


        void INativeScintilla.SetSelFore(bool useSelectionForeColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSELFORE, useSelectionForeColour, colour);
        }


        void INativeScintilla.SetStatus(int status)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSTATUS, status, 0);
        }


        void INativeScintilla.SetStyleBits(int bits)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSTYLEBITS, bits, 0);
        }


        void INativeScintilla.SetStyling(int length, int style)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSTYLING, length, style);
        }


        void INativeScintilla.SetStylingEx(int length, string styles)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETSTYLINGEX, length, styles);
        }


        void INativeScintilla.SetTabIndents(bool tabIndents)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTABINDENTS, tabIndents, 0);
        }


        void INativeScintilla.SetTabWidth(int widthInChars)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTABWIDTH, widthInChars, 0);
        }


        void INativeScintilla.SetTargetEnd(int pos)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTARGETEND, pos, 0);
        }


        void INativeScintilla.SetTargetStart(int pos)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTARGETSTART, pos, 0);
        }


        void INativeScintilla.SetText(string text)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTEXT, VOID.NULL, text);
        }


        void INativeScintilla.SetTwoPhaseDraw(bool twoPhase)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETTWOPHASEDRAW, twoPhase, 0);
        }


        void INativeScintilla.SetUndoCollection(bool collectUndo)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETUNDOCOLLECTION, collectUndo, 0);
        }


        void INativeScintilla.SetUsePalette(bool allowPaletteUse)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETUSEPALETTE, allowPaletteUse, 0);
        }


        void INativeScintilla.SetUseTabs(bool useTabs)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETUSETABS, useTabs, 0);
        }


        void INativeScintilla.SetViewEol(bool visible)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETVIEWEOL, visible, 0);
        }


        void INativeScintilla.SetViewWs(int wsMode)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETVIEWWS, wsMode, 0);
        }


        void INativeScintilla.SetVisiblePolicy(int visiblePolicy, int visibleSlop)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETVISIBLEPOLICY, visiblePolicy, visibleSlop);
        }


        void INativeScintilla.SetVScrollBar(bool visible)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETVSCROLLBAR, visible, 0);
        }


        void INativeScintilla.SetWhitespaceBack(bool useWhitespaceBackColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETWHITESPACEBACK, useWhitespaceBackColour, colour);
        }


        void INativeScintilla.SetWhitespaceChars(string chars)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETWHITESPACECHARS, VOID.NULL, chars);
        }


        void INativeScintilla.SetWhitespaceFore(bool useWhitespaceForeColour, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETWHITESPACEFORE, useWhitespaceForeColour, colour);
        }


        void INativeScintilla.SetWordChars(string chars)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETWORDCHARS, VOID.NULL, chars);
        }


        void INativeScintilla.SetXCaretPolicy(int caretPolicy, int caretSlop)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETXCARETPOLICY, caretPolicy, caretSlop);
        }


        void INativeScintilla.SetXOffset(int xOffset)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETXOFFSET, xOffset, 0);
        }


        void INativeScintilla.SetYCaretPolicy(int caretPolicy, int caretSlop)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETYCARETPOLICY, caretPolicy, caretSlop);
        }


        void INativeScintilla.SetZoom(int zoomInPoints)
        {
            this._ns.SendMessageDirect(Constants.SCI_SETZOOM, zoomInPoints, 0);
        }


        void INativeScintilla.ShowLines(int lineStart, int lineEnd)
        {
            this._ns.SendMessageDirect(Constants.SCI_SHOWLINES, lineStart, lineEnd);
        }


        void INativeScintilla.StartRecord()
        {
            this._ns.SendMessageDirect(Constants.SCI_STARTRECORD, 0, 0);
        }


        void INativeScintilla.StartStyling(int position, int mask)
        {
            this._ns.SendMessageDirect(Constants.SCI_STARTSTYLING, position, mask);
        }


        void INativeScintilla.StopRecord()
        {
            this._ns.SendMessageDirect(Constants.SCI_STOPRECORD, 0, 0);
        }


        void INativeScintilla.StutteredPageDown()
        {
            this._ns.SendMessageDirect(Constants.SCI_STUTTEREDPAGEDOWN, 0, 0);
        }


        void INativeScintilla.StutteredPageDownExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_STUTTEREDPAGEDOWNEXTEND, 0, 0);
        }


        void INativeScintilla.StutteredPageUp()
        {
            this._ns.SendMessageDirect(Constants.SCI_STUTTEREDPAGEUP, 0, 0);
        }


        void INativeScintilla.StutteredPageUpExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_STUTTEREDPAGEUPEXTEND, 0, 0);
        }


        void INativeScintilla.StyleClearAll()
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLECLEARALL, 0, 0);
        }


        int INativeScintilla.StyleGetBack(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETBACK, styleNumber, 0);
        }


        bool INativeScintilla.StyleGetBold(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETBOLD, styleNumber, 0) != 0;
        }


        int INativeScintilla.StyleGetCase(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETCASE, styleNumber, 0);
        }


        bool INativeScintilla.StyleGetChangeable(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETCHANGEABLE, styleNumber, 0) != 0;
        }


        int INativeScintilla.StyleGetCharacterSet(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETCHARACTERSET, styleNumber, 0);
        }


        bool INativeScintilla.StyleGetEOLFilled(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETEOLFILLED, styleNumber, 0) != 0;
        }
        ...
        {
            string s;
            int length = this._ns.SendMessageDirect(Constants.SCI_STYLEGETFONT, styleNumber, 0);
            this._ns.SendMessageDirect(Constants.SCI_STYLEGETFONT, (IntPtr)styleNumber, out s, length);
            fontName = s;
        }
        ...
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETFORE, styleNumber, 0);
        }


        bool INativeScintilla.StyleGetHotspot(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETHOTSPOT, styleNumber, 0) != 0;
        }


        bool INativeScintilla.StyleGetItalic(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETITALIC, styleNumber, 0) != 0;
        }


        int INativeScintilla.StyleGetSize(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETSIZE, 0, 0);
        }


        bool INativeScintilla.StyleGetUnderline(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETUNDERLINE, styleNumber, 0) != 0;
        }


        bool INativeScintilla.StyleGetVisible(int styleNumber)
        {
            return this._ns.SendMessageDirect(Constants.SCI_STYLEGETVISIBLE, styleNumber, 0) != 0;
        }


        void INativeScintilla.StyleResetDefault()
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLERESETDEFAULT, 0, 0);
        }


        void INativeScintilla.StyleSetBack(int styleNumber, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETBACK, styleNumber, colour);
        }


        void INativeScintilla.StyleSetBold(int styleNumber, bool bold)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETBOLD, styleNumber, bold);
        }


        void INativeScintilla.StyleSetCase(int styleNumber, int caseMode)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETCASE, styleNumber, caseMode);
        }


        void INativeScintilla.StyleSetChangeable(int styleNumber, bool changeable)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETCHANGEABLE, styleNumber, changeable);
        }


        void INativeScintilla.StyleSetCharacterSet(int styleNumber, int charSet)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETCHARACTERSET, styleNumber, charSet);
        }


        void INativeScintilla.StyleSetEOLFilled(int styleNumber, bool eolFilled)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETEOLFILLED, styleNumber, eolFilled);
        }


        void INativeScintilla.StyleSetFont(int styleNumber, string fontName)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETFONT, styleNumber, fontName);
        }


        void INativeScintilla.StyleSetFore(int styleNumber, int colour)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETFORE, styleNumber, colour);
        }


        void INativeScintilla.StyleSetHotspot(int styleNumber, bool hotspot)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETHOTSPOT, styleNumber, hotspot);
        }


        void INativeScintilla.StyleSetItalic(int styleNumber, bool italic)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETITALIC, styleNumber, italic);
        }


        void INativeScintilla.StyleSetSize(int styleNumber, int sizeInPoints)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETSIZE, styleNumber, sizeInPoints);
        }


        void INativeScintilla.StyleSetUnderline(int styleNumber, bool underline)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETUNDERLINE, styleNumber, underline);
        }


        void INativeScintilla.StyleSetVisible(int styleNumber, bool visible)
        {
            this._ns.SendMessageDirect(Constants.SCI_STYLESETVISIBLE, styleNumber, visible);
        }


        void INativeScintilla.Tab()
        {
            this._ns.SendMessageDirect(Constants.SCI_TAB, 0, 0);
        }
        ...
        {
            this._ns.SendMessageDirect(Constants.SCI_TARGETFROMSELECTION, 0, 0);
        }


        int INativeScintilla.TextHeight(int line)
        {
            return this._ns.SendMessageDirect(Constants.SCI_TEXTHEIGHT, line, 0);
        }


        int INativeScintilla.TextWidth(int styleNumber, string text)
        {
            return this._ns.SendMessageDirect(Constants.SCI_TEXTWIDTH, styleNumber, text);
        }


        void INativeScintilla.ToggleCaretSticky()
        {
            this._ns.SendMessageDirect(Constants.SCI_TOGGLECARETSTICKY, 0, 0);
        }


        void INativeScintilla.ToggleFold(int line)
        {
            this._ns.SendMessageDirect(Constants.SCI_TOGGLEFOLD, line, 0);
        }


        void INativeScintilla.Undo()
        {
            this._ns.SendMessageDirect(Constants.SCI_UNDO, 0, 0);
        }


        void INativeScintilla.UpperCase()
        {
            this._ns.SendMessageDirect(Constants.SCI_UPPERCASE, 0, 0);
        }


        void INativeScintilla.UsePopUp(bool bEnablePopup)
        {
            this._ns.SendMessageDirect(Constants.SCI_USEPOPUP, bEnablePopup, 0);
        }


        void INativeScintilla.UserListShow(int listType, string list)
        {
            this._ns.SendMessageDirect(Constants.SCI_USERLISTSHOW, listType, list);
        }


        void INativeScintilla.VCHome()
        {
            this._ns.SendMessageDirect(Constants.SCI_VCHOME, 0, 0);
        }


        void INativeScintilla.VCHomeExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_VCHOMEEXTEND, 0, 0);
        }


        void INativeScintilla.VCHomeRectExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_VCHOMERECTEXTEND, 0, 0);
        }


        void INativeScintilla.VCHomeWrap()
        {
            this._ns.SendMessageDirect(Constants.SCI_VCHOMEWRAP, 0, 0);
        }


        void INativeScintilla.VCHomeWrapExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_VCHOMEWRAPEXTEND, 0, 0);
        }


        int INativeScintilla.VisibleFromDocLine(int docLine)
        {
            return this._ns.SendMessageDirect(Constants.SCI_VISIBLEFROMDOCLINE, docLine, 0);
        }


        int INativeScintilla.WordEndPosition(int position, bool onlyWordCharacters)
        {
            return this._ns.SendMessageDirect(Constants.SCI_WORDENDPOSITION, position, onlyWordCharacters);
        }


        void INativeScintilla.WordLeft()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDLEFT, 0, 0);
        }


        void INativeScintilla.WordLeftEnd()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDLEFTEND, 0, 0);
        }


        void INativeScintilla.WordLeftEndExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDLEFTENDEXTEND, 0, 0);
        }


        void INativeScintilla.WordLeftExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDLEFTEXTEND, 0, 0);
        }


        void INativeScintilla.WordPartLeft()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDPARTLEFT, 0, 0);
        }


        void INativeScintilla.WordPartLeftExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDPARTLEFTEXTEND, 0, 0);
        }


        void INativeScintilla.WordPartRight()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDPARTRIGHT, 0, 0);
        }


        void INativeScintilla.WordPartRightExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDPARTRIGHTEXTEND, 0, 0);
        }


        void INativeScintilla.WordRight()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDRIGHT, 0, 0);
        }


        void INativeScintilla.WordRightEnd()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDRIGHTEND, 0, 0);
        }


        void INativeScintilla.WordRightEndExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDRIGHTENDEXTEND, 0, 0);
        }


        void INativeScintilla.WordRightExtend()
        {
            this._ns.SendMessageDirect(Constants.SCI_WORDRIGHTEXTEND, 0, 0);
        }


        int INativeScintilla.WordStartPosition(int position, bool onlyWordCharacters)
        {
            return this._ns.SendMessageDirect(Constants.SCI_WORDSTARTPOSITION, position, onlyWordCharacters);
        }


        void INativeScintilla.ZoomIn()
        {
            this._ns.SendMessageDirect(Constants.SCI_ZOOMIN, 0, 0);
        }


        void INativeScintilla.ZoomOut()
        {
            this._ns.SendMessageDirect(Constants.SCI_ZOOMOUT, 0, 0);
        }
