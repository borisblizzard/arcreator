...
namespace ARCed.Scintilla
{
    ...
    public class Whitespace : TopLevelHelper
    {
        ...
        ///     Setting the <chr>BackColor</chr> to anything other than <see cref="Color.Empty"/> overrides the lexer behavior.
        ...
        ///     Setting the <chr>ForeColor</chr> to anything other than <see cref="Color.Empty"/> overrides the lexer behavior.
        ///     Transparent colors are not supported.
        /// </remarks>
        /// <returns>
