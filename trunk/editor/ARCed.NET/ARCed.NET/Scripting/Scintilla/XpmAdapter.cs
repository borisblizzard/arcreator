...
namespace ARCed.Scintilla
{
    ...
    internal static class XpmConverter
    {
        ...
        /// </summary>
        /// <param name="bmp">The _image to transform.</param>
        ...
        /// <summary>
        ///     Cicles an _image list object to convert contained images into xpm
        ///     at the same time we add converted images into an arraylist that lets us to retrieve images later.
        ///     Uses the DefaultTransparentColor.
        /// </summary>
        /// <param name="imageList">The _image list to transform.</param>
