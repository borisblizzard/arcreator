namespace ARCed.Database.Actors
{
	partial class ActorParametersForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.buttonQuickE.Click += new System.EventHandler(this.buttonQuickCurve_Click);
			// 
			// buttonQuickC
			// 
			...
			this.buttonQuickC.Click += new System.EventHandler(this.buttonQuickCurve_Click);
			// 
			// buttonQuickB
			// 
			...
			this.buttonQuickB.Click += new System.EventHandler(this.buttonQuickCurve_Click);
			// 
			// buttonQuickD
			// 
			...
			this.buttonQuickD.Click += new System.EventHandler(this.buttonQuickCurve_Click);
			// 
			// buttonQuickA
			// 
			...
			this.buttonQuickA.Click += new System.EventHandler(this.buttonQuickCurve_Click);
			// 
			// labelCoordX
			// 
			...
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.ActorParametersForm_FormClosing);
