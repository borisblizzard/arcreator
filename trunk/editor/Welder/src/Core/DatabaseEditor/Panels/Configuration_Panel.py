...
class Configuration_Panel (wx.Panel, PanelBase):
    ...
    def __init__(self, parent):
        ...
        self.scrolledWindowEquipment = wx.ScrolledWindow(
            self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.CLIP_CHILDREN | wx.HSCROLL | wx.SIMPLE_BORDER | wx.VSCROLL)
        ...
        self.staticSectionLine = wx.StaticLine(
            self.scrolledWindowEquipment, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL)
