...
class ARC_Dump(object):
	...
	@staticmethod
	def _dump_none(obj):
		_io.write(ARC_Dump._TYPES["NoneClass"])
	

	@staticmethod
	def _dump_false(obj):
		_io.write(ARC_Dump._TYPES["FalseClass"])
	

	@staticmethod
	def _dump_true(obj):
		_io.write(ARC_Dump._TYPES["TrueClass"])
	
	
	@staticmethod
	def _dump_fixnum(obj):
		_io.write(ARC_Dump._TYPES["Fixnum"])
		ARC_Dump.__dump_int32(obj)
	
	
	@staticmethod
	def _dump_bignum(obj):
		_io.write(ARC_Dump._TYPES["Bignum"])
		ARC_Dump.__dump_int32(obj) # our C++ implementation uses a "long" of 32 bit
	
	
	@staticmethod
	def _dump_float(obj):
		_io.write(ARC_Dump._TYPES["Float"])
	...
	def _dump_object(obj):
		_io.write(ARC_Dump._TYPES["Object"])
	...
	def _load_object():
		...
		obj = ARC_Dump.__find_mapped(_objects, ARC_Dump.__load_int32())
		if obj != None:
			return obj
