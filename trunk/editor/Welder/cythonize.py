...
XAL_ext = Extension(
    ...
    include_dirs=[
        r"Core/PyXAL/src/include",      # list of paths to search for header files
        r"C:/Python33/include",
        r"C:/Python33/PC"
    ],
    library_dirs=[
        r"Core/PyXAL/src/bin",
        r"Cor/PyXAL/src/lib",
        r"C:/Python33/libs",
        'C:/Python33/PCbuild', ],        # list of paths to search for libraries at link time
