import wx
from ARCed_Templates import Enemies_Panel
from ARCedEnemyExpGold_Dialog import ARCedEnemyExpGold_Dialog
import ARCedChooseGraphic_Dialog
from ARCedChooseTreasure_Dialog import ARCedChooseTreasure_Dialog
...
class ARCedEnemies_Panel( Enemies_Panel ):
	...
	def comboBoxExp_Clicked( self, event ):
		...
		if DM.ARC_FORMAT:
			...
			variance = None
		dialog = ARCedEnemyExpGold_Dialog(self, 'Experience:', 
	...
	def comboBoxGold_Clicked( self, event ):
		...
		if DM.ARC_FORMAT:
			...
			variance = None
		dialog = ARCedEnemyExpGold_Dialog(self, 'Gold:', 
	...
	def comboBoxTreasure_Clicked( self, event ):
		...
		dialog = ARCedChooseTreasure_Dialog(self, treasure)
		if dialog.ShowModal() == wx.ID_OK:
