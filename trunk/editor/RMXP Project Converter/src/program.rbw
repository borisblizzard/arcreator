...
class ConverterFrame < Wx::Frame
  ...
  def updateOutputUIUpdate(event)
    if @output_tb.get_value != @log
  ...
  def display_end_message
    if @errors
      ...
      message += "\n\nWould you like to convert another project? \n Selecting no will close the Converter"
      dialog = Wx::MessageDialog.new(self, message, 
        "Project Successfully Converted", 
        Wx::ICON_QUESTION|Wx::YES_NO|Wx::YES_DEFAULT|Wx::STAY_ON_TOP)
