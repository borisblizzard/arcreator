...
namespace rgss
{
	...
	void Window::_updateCursorSprite()
	{
		...
		this->cursorSprite->setOpacity(this->contentsOpacity);
	...
	void Window::createRubyInterface()
	{
		...
		rb_define_method(rb_cWindow, "height", RUBY_METHOD_FUNC(&Window::rb_getWidth), 0);
