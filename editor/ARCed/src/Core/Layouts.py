...
class RMXPMainWindow(object):
    ...
    def CreateMapEditor(self):
        mappanel = KM.get_component("MapEditorWindow", "RMXP").object
        self.parent.mapEditerPanel = mappanel(self.parent,
                                              self.parent._notebook_style)
        self.parent._mgr.AddPane(self.parent.mapEditerPanel, aui.AuiPaneInfo().
    ...
    def CreateTilesetView(self):
        ...
        self.parent._mgr.AddPane(self.parent.tilesetscroll, aui.AuiPaneInfo().
    ...
    def CreateTreeCtrl(self):
        treectrl = KM.get_component("MainMapTreeCtrl", "RMXP").object
        self.parent.maptree = treectrl(self.parent, self.parent.mapEditerPanel)
        self.parent._mgr.AddPane(self.parent.maptree, aui.
