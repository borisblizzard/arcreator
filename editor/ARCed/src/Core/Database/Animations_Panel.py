...
from Core.Database.Dialogs import ChangeMaximum_Dialog, ChooseGraphic_Dialog, AnimationTiming_Dialog, AnimationTweening_Dialog, AnimationCellBatch_Dialog, AnimationCellProperties_Dialog, AnimationEntireSlide_Dialog
