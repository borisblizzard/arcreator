...
class DatabaseManager(object):
    ...
    def GetAddSubImageList():
        ...
        imageList.Add(IconManager.getBitmap('check_empty'))
        imageList.Add(IconManager.getBitmap('check_plus'))
        imageList.Add(IconManager.getBitmap('check_minus'))
        return imageList
    ...
    def GetNormalCheckImageList():
        ...
        imageList = wx.ImageList(14, 12)
        imageList.Add(IconManager.getBitmap('check_empty'))
        imageList.Add(IconManager.getBitmap('check_green'))
        return imageList
