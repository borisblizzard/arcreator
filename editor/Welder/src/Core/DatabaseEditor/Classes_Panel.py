...
Skill_Dialog = Core.Database.Dialogs.Skill_Dialog
RPGutil = Core.RPGutil
DatabaseActions = Core.DatabaseActions
...
class Classes_Panel( Templates.Classes_Panel, PanelBase ):
