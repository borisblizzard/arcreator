...
from PyitectConsumes import DatabaseManager
...
class AudioPlayer_Panel( Templates.AudioPlayer_Panel, PanelBase ):
    def __init__( self, parent, rpgfile=None, directory=None ):
        ...
        DatabaseManager.DrawButtonIcon(self.buttonPlay, 'play_button', True)
        DatabaseManager.DrawButtonIcon(self.buttonPause, 'pause_button', True)
        DatabaseManager.DrawButtonIcon(self.buttonStop, 'stop_button', True)
    ...
    def RefreshActivePage( self ):
        ...
        chan = self.Channels[self.AudioIndex]
        DatabaseManager.FillWithoutNumber(self.listBoxAudio, [], self.files[self.AudioIndex])
...
class AudioChannel(object):
    ...
    def __init__(self):
        ...
        # obtain a PyXAL interface
        self.PyXAL = DatabaseManager.getPyXAL()
        self.player = None
        self.sound = None
