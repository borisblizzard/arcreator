import wx
from ARCed_Templates import GenerateCurve_Dialog
import wx.lib.agw.floatspin as floatspin
import numpy as np
from DatabaseManager import DatabaseManager as DM
import Kernel

class ARCedGenerateCurve_Dialog( GenerateCurve_Dialog ):
	def __init__( self, parent, vRange, lRange, max):
		"""Basic constructor for the ARCedGenerateCurve_Dialog"""
		GenerateCurve_Dialog.__init__( self, parent )
