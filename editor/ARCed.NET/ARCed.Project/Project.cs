...
namespace ARCed
{
    public static class Project
    {
        ...
        public delegate void OnCreateHandler(object sender, EventArgs e);
        public delegate void OnOpenHandler(object sender, EventArgs e);
        public delegate void OnCloseHandler(object sender, EventArgs e);
        public delegate void OnSavedHandler(object sender, EventArgs e);
        public delegate void OnARChiveHandler(object sender, EventArgs e);
        public delegate void OnRenamHandler(object sender, EventArgs e);
        public delegate void OnDataChangedHandler(object sender, EventArgs e);
        public delegate void OnSettingsChangedHandler(object sender, EventArgs e);
        ...
        public static event OnARChiveHandler ARChived;
        public static event OnRenamHandler Renamed;
        public static event OnDataChangedHandler DataChanged;
        public static event OnSettingsChangedHandler SettingsChanged;
        ...
        public static bool Save()
        {
            try
            {
                Util.SaveXML<ProjectSettings>(SettingsFile, _settings);
                return true;
            }
            catch { return false; }
        }
        ...
        private static bool LoadGameData()
        {
            try
            {
                Project.Data = new GameData();
                TypeMap map = Util.RpgTypes;
                Project.Data.Tilesets = LoadArcData<List<dynamic>>("Tilesets.arc", map);
                ...
                Project.Data.Actors = LoadArcData<List<dynamic>>("Actors.arc", map);
                Project.Data.Classes = LoadArcData<List<dynamic>>("Classes.arc", map);
                Project.Data.Items = LoadArcData<List<dynamic>>("Items.arc", map);
                Project.Data.Weapons = LoadArcData<List<dynamic>>("Weapons.arc", map);
                Project.Data.Armors = LoadArcData<List<dynamic>>("Armors.arc", map);
                Project.Data.Skills = LoadArcData<List<dynamic>>("Skills.arc", map);
                Project.Data.States = LoadArcData<List<dynamic>>("States.arc", map);
                Project.Data.CommonEvents = LoadArcData<List<dynamic>>("CommonEvents.arc", map);
                Project.Data.System = LoadArcData<RPG.System>("System.arc", map);
                Project.Data.Enemies = LoadArcData<List<dynamic>>("Enemies.arc", map);
                Project.Data.Troops = LoadArcData<List<dynamic>>("Troops.arc", map);
                return true;
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <typeparam name="T">Specifies the <paramref name="System.Type"/> of the 
        ...
        {
            SevenZipExtractor.SetLibraryPath(library);
        ...
        {
            int max = _settings.ARChiveSettings.MaxBackups;
            List<FileInfo> infos;
