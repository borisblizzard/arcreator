...
namespace ARCed
{
	partial class Editor
	{
		...
		/// <summary>
		/// The globally accessible progress bar for the editor
		/// </summary>
		...
		/// <summary>
		/// Gets a list of opened script filenames
		/// </summary>
		internal static List<string> OpenScriptsFiles
		{
			get
			{
				List<string> files = new List<string>();
				foreach (ScriptEditorForm editor in Windows.ScriptEditors)
					files.Add(editor.Script.Filename);
				return files;
			}
		}
