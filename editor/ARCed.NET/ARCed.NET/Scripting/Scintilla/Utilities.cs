...
namespace ARCed.Scintilla
{
    public static class Utilities
    {
        ...
        /// </summary>
        /// <remarks>
        ///     I'd love to have this as en extension method but ARCed.Scintilla's probably going to be 2.0 for a long
        ///     time to come. There's nothing really compelling in later versions that applies to ARCed.Scintilla that
